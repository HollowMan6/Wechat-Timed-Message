...
[Docker镜像](https://hub.docker.com/r/hollowman6/send-message-to-wechat)支持在`amd64`、`arm64`、`arm v7`、`arm v6`、`arm v5`、`ppc64le`、`s390x`、`386`多架构运行。
...
[Docker Image](https://hub.docker.com/r/hollowman6/send-message-to-wechat) support running on multiple architectures such as `amd64`, `arm64`, `arm v7`, `arm v6`, `arm v5`, `ppc64le`, `s390x`, `386`.
